...
- unreadable: a document is there but cannot be read, because the file will not open or it opens to something no one can read (corrupt, encrypted, a blank or scanned image with no text layer, garbled output).
